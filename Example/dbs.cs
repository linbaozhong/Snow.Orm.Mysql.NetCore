...
namespace Snow.Orm
{
    ...
    public static class dbs
    {
        ...
        static dbs()
        {
            ...
            Db = new Snow.Orm.DB("Data Source=localhost;database=snow_shop;user id=root;password=123456;Pooling=true;Max Pool Size=100;Min Pool Size=1;default command timeout=20;characterset=utf8", 0, Log, true);
        }
